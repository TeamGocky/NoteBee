...
ode to a publicly accessible forum for their research area to intice
...
\begin{itemize}
\item Add simulation of software degradation and how it's entropy
decreases over time in a safety-critical environment.
...
\begin{tabular}{*{6}{|L}|}
\hline
I want to... & Overall Priority & Barry & Bill
& Jane\\
\hline
