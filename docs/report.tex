...
%\begin{figure}
%\includegraphics[width=\textwidth*0.5]{../imgs/InitialHomepageHorz.png}
%\caption{Blank Homepage}
%\label{fig:blankPage}
%\end{figure}
%
%\begin{figure}
%\includegraphics[width=\textwidth * 0.5]{../imgs/homepageWireFrameGRHorz.png}
%\caption{Anonymous snippet being posted.}
%\label{fig:anonsnippet}
%\end{figure}
%
%\begin{figure}
%\includegraphics[width=\textwidth * 0.5]{../imgs/CCodeSnippetHorz.png}
%\caption{Joe's home screen with his code snippet}
%\label{fig:joe}
%\end{figure}
%
%\begin{figure}
%\includegraphics[width=\textwidth * 0.5]{../imgs/LoggedInViewSnippetHorz.png}
%\caption{Jane viewing a posted snippet.}
%\label{fig:LoggedInViewJane}
%\end{figure}
%
%\begin{figure}
%\includegraphics[width=\textwidth * 0.5]{../imgs/viewingCategoriesHorz.png}
%\caption{Jane looking at the categories of snippet.}
%\label{fig:viewCategories}
%\end{figure}
%
%\begin{figure}
%\includegraphics[width=\textwidth * 0.5]{../imgs/CSnippetAfterSubmissionHorz.png}
...
%\begin{figure}[H]
%\centering
%\includegraphics[scale=0.5]{../imgs/N-TierArchitecture.png}
...
%\begin{figure}[H]
%\centering
%\includegraphics[scale=0.5]{../imgs/ERDiagram.png}
